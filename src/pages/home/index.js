...
const Home = () => {
  ...
  return (
    <>
      <HeroSection />
      <h1 className="font-bold  text-2xl mb-3">Pekerjaan teratas : </h1>
      <div className="bg-sky-100 p-3 rounded flex flex-wrap gap-5 justify-center">
      {dataJob == null && 
      ...
      {dataJob != null && dataJob.filter((res,index) => {
        return index < 4
      }).map((res, index) => {
        return(
